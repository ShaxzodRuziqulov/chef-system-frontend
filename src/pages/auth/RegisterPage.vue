  ...
  <div class="register-page">
    ...
    <div class="card">
      ...
      <form @submit.prevent="onSubmit" novalidate class="form">
        ...
        <!-- Username -->
        <div class="field-group">
          <label class="field-label">{{ lang.t('auth.username') }} <span class="required">*</span></label>
        ...
        <!-- Password -->
        <div class="field-group">
          <label class="field-label">{{ lang.t('auth.password') }} <span class="required">*</span></label>
